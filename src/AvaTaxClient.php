...
class LocationModel
{
    ...
    /**
     * @var object[] Extra information required by certain jurisdictions for filing.
...
class ParameterModel
{
    ...
    /**
     * @var string The category grouping of this parameter. When your user interface displays a large number of parameters, they should
be grouped by their category value.
    ...
    /**
     * @var string Help text to be shown to the user when they are filling out this parameter. Help text may include HTML links to additional
content with more information about a parameter.
    ...
    /**
     * @var string The prompt you should use when displaying this parameter to a user. For example, if your user interface displays a
parameter in a text box, this is the label you should use to identify that text box.
     */
    public $prompt;

    /**
     * @var string If your user interface permits client-side validation of parameters, this string is a regular expression you can use
...
class TaxRateModel
{
    ...
    /**
     * @var float The total sales tax rate for general tangible personal property sold at a retail point of presence
in this jurisdiction on this date.
     */
    public $totalRate;

    /**
     * @var object[] The list of individual rate elements for general tangible personal property sold at a retail
...
transfer transaction represents goods that were moved from one location of the company to another location without changing ownership. (See DocumentType::* for a list of allowable values)
    ...
    /**
     * @var string (DEPRECATED) This field has been replaced by the reportingLocationCode field
...
Get, Adjust, Settle, and Void. If you leave the transaction code blank, a GUID will be assigned to each transaction.
    ...
    /**
     * @var string Specifies the type of document to create. A document type ending with `Invoice` is a permanent transaction
that will be recorded in AvaTax. A document type ending with `Order` is a temporary estimate that will not
be preserved.

If you omit this value, the API will assume you want to create a `SalesOrder`. (See DocumentType::* for a list of allowable values)
     */
    public $type;
...
To get a full list of available parameters, please use the `/api/v2/definitions/parameters` endpoint.
    ...
    /**
     * @var string Customer-provided Reference Code with information about this transaction.
...
class LineItemModel
{
    ...
    /**
     * @var object The addresses to use for this transaction line.
...
class SettleTransactionModel
{
    ...
    /**
     * @var object To use the "Settle" endpoint to commit a transaction for reporting purposes, fill out this value.
...
class CreateOrAdjustTransactionModel
{
    ...
    /**
     * @var object The create transaction model to be created or updated. 
...
class MultiCompanyLineItemModel
{
    ...
    /**
     * @var string Company Code - Specify the code of the company for this line of transaction. If you leave this value null,
