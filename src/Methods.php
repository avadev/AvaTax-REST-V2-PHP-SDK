...
class AvaTaxClient extends AvaTaxClientBase
{
    ...
    public function accountResetLicenseKey($id, $model)    {
        ...
        return $this->restCall($path, 'POST', $guzzleParams,'22.5.0' );
    }
    ...
    public function auditAccount($id, $start, $end, $top=null, $skip=null)    {
        ...
        return $this->restCall($path, 'GET', $guzzleParams,'22.5.0' );
    }
    ...
    public function deleteLicenseKey($id, $licensekeyname)    {
        ...
        return $this->restCall($path, 'DELETE', $guzzleParams,'22.5.0' );
    }
    ...
    public function updateLookupFile($accountId, $id, $model)    {
        ...
        return $this->restCall($path, 'PUT', $guzzleParams,'22.5.0' );
    }
     ...
     * @return FetchResult
     */
    public function listJurisdictionsByRateTypeTaxTypeMapping($country, $taxTypeId, $taxSubTypeId, $rateTypeId, $filter=null, $top=null, $skip=null, $orderBy=null)    {
    ...
    public function getClassificationStatus($companyId, $includeClassificationDetails, $filter=null, $top=null, $skip=null, $orderBy=null)    {
        $path = "/api/v2/companies/{$companyId}/classificationrequests/taxcode";
        $guzzleParams = [
            'query' => ['$includeClassificationDetails' => $includeClassificationDetails, '$filter' => $filter, '$top' => $top, '$skip' => $skip, '$orderBy' => $orderBy],
            'body' => null
        ];
        return $this->restCall($path, 'GET', $guzzleParams,'22.5.0' );
    }
    ...
    public function resetPassword($userId, $isUndoMigrateRequest, $model)    {
        ...
        $guzzleParams = [
            'query' => ['isUndoMigrateRequest' => $isUndoMigrateRequest],
            'body' => json_encode($model)
        ];
        return $this->restCall($path, 'POST', $guzzleParams,'22.5.0' );
    }
