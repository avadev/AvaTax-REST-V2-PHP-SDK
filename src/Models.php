...
class TaxRuleModel
{
    ...
    /**
     * @var int The unique ID number of the tax code for this rule.  When creating or updating a tax rule, you may specify either the taxCodeId value or the taxCode value.    If both `taxCodeId` and `taxCode` are null, this tax rule will apply to all tax codes.
     */
    public $taxCodeId;

    /**
     * @var string The code string of the tax code for this rule.  When creating or updating a tax rule, you may specify either the taxCodeId value or the taxCode value.    If both `taxCodeId` and `taxCode` are null, this tax rule will apply to all tax codes.
     */
    public $taxCode;
    ...
    /**
     * @var string The type of customer usage to which this rule applies.    For a full list of entity use codes, see the `ListEntityUseCodes` API.
     */
    public $entityUseCode;
